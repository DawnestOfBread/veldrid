    ...
    internal unsafe class VkResourceSet : ResourceSet
    {
            ...
            : base(ref description)
        {
            ...
            for (int i = 0; i < descriptorWriteCount; i++)
            {
                ...
                if (type is VkDescriptorType.UniformBuffer or VkDescriptorType.UniformBufferDynamic or VkDescriptorType.StorageBuffer or VkDescriptorType.StorageBufferDynamic)
                {
